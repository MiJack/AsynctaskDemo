...
public class Task1 extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String s) {
        com.mijack.Xlog.logMethodEnter("void cn.mijack.asynctaskdemo.Task1.onPostExecute(java.lang.String)",this,s);try{System.out.println("receive:" + s);com.mijack.Xlog.logMethodExit("void cn.mijack.asynctaskdemo.Task1.onPostExecute(java.lang.String)",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void cn.mijack.asynctaskdemo.Task1.onPostExecute(java.lang.String)",this,throwable);throw throwable;}
    }
}
