...
public class Task12 extends AsyncTask<Integer, Integer, String> {
    ...
    protected void onProgressUpdate(Integer... values) {
        com.mijack.Xlog.logMethodEnter("void cn.mijack.asynctaskdemo.Task12.onProgressUpdate([java.lang.Integer)",this,values);try{System.out.println("onProgressUpdate:" + values[0]);com.mijack.Xlog.logMethodExit("void cn.mijack.asynctaskdemo.Task12.onProgressUpdate([java.lang.Integer)",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void cn.mijack.asynctaskdemo.Task12.onProgressUpdate([java.lang.Integer)",this,throwable);throw throwable;}
    }
}
